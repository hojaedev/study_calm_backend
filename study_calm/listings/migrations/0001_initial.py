    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operational_hours_24', models.BooleanField()),
                ('operational_hours_overnight', models.BooleanField(blank=True, default=None, null=True)),
                ('operational_hours_start', models.TimeField(blank=True, default=None, null=True)),
                ('operational_hours_end', models.TimeField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('room', 'Room'), ('seat', 'Seat'), ('all', 'All Category')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.ManyToManyField(blank=True, to='listings.ProductDetail')),
